...
class Application_Model_Datatables {
    ...
    public static function dt($sTable, array $aColumns)
    {
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ )
		{
                    ...
                    {  
                        ...
                        case "id":
                            $row[] = $aRow[ $aColumns[$i] ];
                            $row[] = "<a href=\"\" class=\"edit\">Edit</a>";
                            $row[] = "<a href=\"javascript:void(0);\" class=\"delete\" onclick=\"deleteRecord(".$aRow[ $aColumns[$i] ].")\">Delete</a>";
                            continue;
                    }
